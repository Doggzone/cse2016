...
11. 게임의 진행하면서 입력은 `swing` 패키지의 `JOptionPane.showInputDialog()` 활용하고, 출력은 `System.out`을 활용하여 실행창에 보여준다. 추후에 이벤트 구동 프로그래밍을 배운 다음 다양한 GUI를 활용한 입출력을 활용하는 걸로 개선할 예정이다.
